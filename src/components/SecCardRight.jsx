...
export default function SecCardRight() {
		...
		<Grid container className={classes.root}>
			<Grid item sm={12} md={6} className={classes.left}>
				<Typography variant='h3' component='h3' gutterBottom>
					<Avatar className={classes.avatar} alt='Remy Sharp' src='lady.png' />
					Full Name
				</Typography>
				<Typography variant='h5' component='h5' gutterBottom noWrap>
					Director Manager of XYZ Gang
				</Typography>
				<Typography
					variant='p'
					component='p'
			...
			<Grid sm={12} md={6} item className={classes.right}>
				<img src={'man-5.jpg'} className={classes.image} />
			</Grid>
		</Grid>
	);
}
